...
- [ ] [<code>bridge: skip present toggle in bridge_free_member() when device is active</code>](https://git.openwrt.org/project/netifd.git/commit/69a5afc9713adf31edbf3228a7a372ada7bba449)
