...
fatal: unable to access 'https://git.openwrt.org/project/uqmi.git/': The requested URL returned error: 503
'
...
fatal: unable to access 'https://git.openwrt.org/project/ustream-ssl.git/': The requested URL returned error: 503
'
